...
/** Equipo pastoral y de liderazgo (nombres ficticios). */
export const team: TeamMember[] = [
  ...
  },
  {
    name: "Raquel Herrera",
    role: {
      es: "Copastora y ministerio de familias",
      en: "Co-Pastor & Family Ministry",
    },
    bio: {
  ...
  },
  {
    name: "Lucía Méndez",
    role: {
      es: "Anciana y cuidado pastoral",
      en: "Elder & Pastoral Care",
    },
    bio: {
  ...
  },
  {
    name: "Noa Ferrer",
    role: {
      es: "Líder de alabanza y medios",
      en: "Worship & Media Leader",
    },
    bio: {
